...
const ParticleVortex: React.FC = () => {
  ...
  const showCases: IShowCase[] = [
    ...
    },
    {
      id: "galacticJam",
      urlPath:
        "?particleLifeTime=1000&particleTraceWidth=0.7&vortexNumber=3&particleNumber=200&backgroundColor=%2315151a",
      title: "GALACTIC JAM"
    },
    {
      id: "timeWindmill",
    ...
    },
    {
      id: "wave13",
      urlPath:
        "?particleLifeTime=1000&particleTraceWidth=150&vortexNumber=3&particleNumber=13&backgroundColor=%232b2b59",
      title: "WAVE 13"
    }
  ];
  ...
  const onGithubLinkClick = () =>
    (window.location.href = "https://github.com/alagiz/relaxator");
